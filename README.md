...
This repository contains my six-week financial data analytics project completed as part of the Yuva internship program.

The project follows a progressive financial analytics workflow using publicly available financial data from the **World Bank World Development Indicators (WDI)**.

Across six weeks, the project covers:
...
The objective was to develop a practical understanding of how financial data can be collected, analyzed, interpreted, visualized, and communicated.
...
- Working with publicly available financial datasets
- Cleaning and validating financial data
- Performing exploratory data analysis
- Building basic financial forecasts
- Identifying and assessing financial risks
- Applying statistical hypothesis testing
- Creating meaningful financial visualizations
- Communicating analytical findings through professional reports
- Using Python and GitHub for reproducible analysis
...
|---|---|---|
| [Week 1](./Week%201) | Understanding Financial Data | Data acquisition, cleaning, EDA and financial indicators |
| [Week 2](./Week%202) | Creating Financial Forecasts | India NPL forecasting using a moving-average model |
| [Week 3](./Week%203) | Risk Analysis | Financial risk identification, assessment and mitigation |
| [Week 4](./Week%204) | Hypothesis Testing | Statistical testing using India's NPL data |
| [Week 5](./Week%205) | Data Visualization | Financial charts, relationships and correlations |
| [Week 6](./Week%206) | Reporting & Presentation | Consolidated findings, insights and recommendations |
...
Measures bank capital and reserves relative to total assets.

**World Bank Code:** `FB.BNK.CAPA.ZS`

### Non-Performing Loans

Measures non-performing loans relative to total gross loans.

**World Bank Code:** `FB.AST.NPER.ZS`

### Private-Sector Credit

Measures domestic credit to the private sector provided by banks as a percentage of GDP.

**World Bank Code:** `FD.AST.PRVT.GD.ZS`
...
- **World Bank API / WDI** — financial data source
